...
/**
 * Verifies all TargetFactory strategies work end-to-end with PlaywrightActions.
 */
public class TargetFactoryPlaywrightTest {
    ...
    @Test
    public void text_shouldLocateByTextEngine() {
